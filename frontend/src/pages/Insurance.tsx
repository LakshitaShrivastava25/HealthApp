...
import { Plus, ShieldCheck, Sparkles, Send, Calculator, UploadCloud, XCircle, Clock, Layers, Trash2 } from 'lucide-react';
                  ...
                  {chat.map((m) =>
                    m.role === 'user' ? (
                      ...
                      <div key={m.id} className="flex justify-start">
                        <div className="bg-surface text-sm rounded-2xl rounded-tl-sm px-4 py-3 max-w-[85%] text-ink-900">
                          {m.content}
                        </div>
                      </div>
                    )
