...
const navItems = [
  ...
  { to: '/documents', label: 'Document Review', icon: FileText },
  { to: '/insurance-policies', label: 'Insurance Policies', icon: ShieldCheck },
  { to: '/doctor-verification', label: 'Doctor Verification', icon: Stethoscope },
  { to: '/accounts', label: 'Users & Accounts', icon: Users },
