  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-teal via-brand-purple to-brand-purpleDark flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <Card className="w-full max-w-sm p-8 relative z-10 !shadow-2xl">
        ...
        <p className="font-bold text-ink-900 text-xl text-center mt-3">HealthNow Admin</p>
        <p className="text-xs text-ink-500 text-center mb-6 flex items-center justify-center gap-1">
          <Lock size={11} /> Staff access only
        </p>

        {step === 'phone' && (
          <>
            <p className="text-sm font-semibold text-ink-900 mb-1">Staff phone number</p>
